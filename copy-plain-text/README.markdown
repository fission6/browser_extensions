#Copy Plain Text (Chrome Extension)
Adds a context menu (right click) item in order to "Copy 'text' Unformatted"

##Installation
Visit <https://chrome.google.com/webstore/detail/gfkjbblipihgggjiinobdmkfemadjeef> to install the extension
